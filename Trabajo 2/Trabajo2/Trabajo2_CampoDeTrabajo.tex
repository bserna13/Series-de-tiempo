...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{resid}\OtherTok{=}\NormalTok{ru\_tz}\SpecialCharTok{@}\NormalTok{testreg}\SpecialCharTok{$}\NormalTok{residuals }\CommentTok{\# residuales del modelo ADF}
\FunctionTok{plot}\NormalTok{(ru\_tz)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Trabajo2_CampoDeTrabajo_files/figure-latex/unnamed-chunk-27-1.pdf}
